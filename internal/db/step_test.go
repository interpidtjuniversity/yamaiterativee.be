...
func Test_StepInsert(t *testing.T) {
	...
	//steps = append(steps,Step{Name: "预编译",CreatorId: 0, CreatorName: "interpidtjuniversity", IsPublic: true, Requires: []string{"maven"}, Command: "mvn", Args: []string{"compile"}})
	//steps = append(steps,Step{Name: "代码合并",CreatorId: 0, CreatorName: "interpidtjuniversity", IsPublic: true})
	//steps = append(steps,Step{Name: "合并后编译",CreatorId: 0, CreatorName: "interpidtjuniversity", IsPublic: true, Requires: []string{"maven"}, Command: "mvn", Args: []string{"compile"}})
